...
abstract class Admin implements ActiveRecordInterface
{
    ...
    public function setFirstname($v)
    {
        ...
        if ($this->firstname !== $v) {
            $this->firstname = $v;
            $this->modifiedColumns[AdminTableMap::COL_FIRSTNAME] = true;
        }
    ...
    public function setLastname($v)
    {
        ...
        if ($this->lastname !== $v) {
            $this->lastname = $v;
            $this->modifiedColumns[AdminTableMap::COL_LASTNAME] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_FIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'firstName';
        }
        if ($this->isColumnModified(AdminTableMap::COL_LASTNAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AdminTableMap::COL_FIRSTNAME)) {
            $criteria->add(AdminTableMap::COL_FIRSTNAME, $this->firstname);
        }
        if ($this->isColumnModified(AdminTableMap::COL_LASTNAME)) {
            $criteria->add(AdminTableMap::COL_LASTNAME, $this->lastname);
        }
        if ($this->isColumnModified(AdminTableMap::COL_EMAIL)) {
