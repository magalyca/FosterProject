 ...
 * @method     ChildAdmin requireOneByFirstname(string $firstName) Return the first ChildAdmin filtered by the firstName column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildAdmin requireOneByLastname(string $lastName) Return the first ChildAdmin filtered by the lastName column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildAdmin[]|ObjectCollection findByFirstname(string $firstName) Return ChildAdmin objects filtered by the firstName column
 * @method     ChildAdmin[]|ObjectCollection findByLastname(string $lastName) Return ChildAdmin objects filtered by the lastName column
...
abstract class AdminQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, firstName, lastName, email, password FROM admin WHERE id = :p0';
        try {
    ...
    public function filterByFirstname($firstname = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AdminTableMap::COL_FIRSTNAME, $firstname, $comparison);
    }
    ...
    public function filterByLastname($lastname = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AdminTableMap::COL_LASTNAME, $lastname, $comparison);
    }
