...
class AdminTableMap extends TableMap
{
     ...
     */
    const COL_FIRSTNAME = 'admin.firstName';

    /**
     * the column name for the lastName field
     */
    const COL_LASTNAME = 'admin.lastName';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Firstname', 'Lastname', 'Email', 'Password', ),
        self::TYPE_CAMELNAME     => array('id', 'firstname', 'lastname', 'email', 'password', ),
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID, AdminTableMap::COL_FIRSTNAME, AdminTableMap::COL_LASTNAME, AdminTableMap::COL_EMAIL, AdminTableMap::COL_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('id', 'firstName', 'lastName', 'email', 'password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Firstname' => 1, 'Lastname' => 2, 'Email' => 3, 'Password' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'firstname' => 1, 'lastname' => 2, 'email' => 3, 'password' => 4, ),
        self::TYPE_COLNAME       => array(AdminTableMap::COL_ID => 0, AdminTableMap::COL_FIRSTNAME => 1, AdminTableMap::COL_LASTNAME => 2, AdminTableMap::COL_EMAIL => 3, AdminTableMap::COL_PASSWORD => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'firstName' => 1, 'lastName' => 2, 'email' => 3, 'password' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AdminTableMap::COL_FIRSTNAME);
            $criteria->addSelectColumn(AdminTableMap::COL_LASTNAME);
