...
class ExpensesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.ExpensesTableMap';
     ...
     */
    const OM_CLASS = '\\Expenses';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Expenses';
    ...
    /**
     * the column name for the expenseType field
     */
    const COL_EXPENSETYPE = 'expenses.expenseType';

    /**
     * the column name for the amount field
     */
    const COL_AMOUNT = 'expenses.amount';

    /**
     * the column name for the dateBought field
     */
    const COL_DATEBOUGHT = 'expenses.dateBought';

    /**
     * the column name for the staffId field
     */
    const COL_STAFFID = 'expenses.staffId';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Expensetype', 'Amount', 'Datebought', 'Staffid', ),
        self::TYPE_CAMELNAME     => array('expensetype', 'amount', 'datebought', 'staffid', ),
        self::TYPE_COLNAME       => array(ExpensesTableMap::COL_EXPENSETYPE, ExpensesTableMap::COL_AMOUNT, ExpensesTableMap::COL_DATEBOUGHT, ExpensesTableMap::COL_STAFFID, ),
        self::TYPE_FIELDNAME     => array('expenseType', 'amount', 'dateBought', 'staffId', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Expensetype' => 0, 'Amount' => 1, 'Datebought' => 2, 'Staffid' => 3, ),
        self::TYPE_CAMELNAME     => array('expensetype' => 0, 'amount' => 1, 'datebought' => 2, 'staffid' => 3, ),
        self::TYPE_COLNAME       => array(ExpensesTableMap::COL_EXPENSETYPE => 0, ExpensesTableMap::COL_AMOUNT => 1, ExpensesTableMap::COL_DATEBOUGHT => 2, ExpensesTableMap::COL_STAFFID => 3, ),
        self::TYPE_FIELDNAME     => array('expenseType' => 0, 'amount' => 1, 'dateBought' => 2, 'staffId' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Expenses');
        $this->setPackage('');
        $this->setUseIdGenerator(false);
        // columns
        $this->addColumn('expenseType', 'Expensetype', 'VARCHAR', true, 32, null);
        $this->addColumn('amount', 'Amount', 'INTEGER', true, null, null);
        $this->addColumn('dateBought', 'Datebought', 'VARCHAR', true, 128, null);
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ExpensesTableMap::COL_EXPENSETYPE);
            $criteria->addSelectColumn(ExpensesTableMap::COL_AMOUNT);
            $criteria->addSelectColumn(ExpensesTableMap::COL_DATEBOUGHT);
            $criteria->addSelectColumn(ExpensesTableMap::COL_STAFFID);
        } else {
            $criteria->addSelectColumn($alias . '.expenseType');
            $criteria->addSelectColumn($alias . '.amount');
            $criteria->addSelectColumn($alias . '.dateBought');
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(ExpensesTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(ExpensesTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new ExpensesTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Expenses) { // it's a model object
...
//
ExpensesTableMap::buildTableMap();
